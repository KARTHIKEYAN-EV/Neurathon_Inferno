// frontend/src/pages/StudentProfile.tsx - UPDATED WITH FIREBASE
...
import { getProfile, updateProfile, type StudentProfile } from "../lib/profileServices"; // NEW IMPORT
...
const StudentProfile = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setEditing(false);
            // No need for toast here - updateProfile already shows one
        } catch (error) {
            console.error("Error saving profile:", error);
            // Error toast is shown by updateProfile function
        }
    };
    ...
    const addSkill = () => {
        ...
        if (skill && draft && !draft.skills.includes(skill)) {
            setDraft({ 
                ...draft, 
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input 
                                            ...
                                            disabled // Email from Firebase shouldn't be edited
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-card rounded-xl border border-border p-6 space-y-3">
                            ...
                            <div className="grid sm:grid-cols-2 gap-3 text-sm">
                                ...
                                <div className="flex items-center gap-2 text-muted-foreground">
                                    <BookOpen className="h-4 w-4" /> {profile.degree}
                                </div>
                                <div className="flex items-center gap-2 text-muted-foreground">
                                    <Calendar className="h-4 w-4" /> Class of {profile.graduationYear}
                                </div>
                            </div>
                        </div>
